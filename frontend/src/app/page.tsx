  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center space-y-16 px-6 py-20 relative min-h-[calc(100vh-80px)]">
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full max-w-2xl px-4">
        {loading ? (
          <div className="flex-1 py-5 px-8 glass rounded-3xl border border-white/20 shadow-2xl flex items-center justify-center">
            <div className="w-6 h-6 animate-spin rounded-full border-2 border-white/30 border-t-white" />
          </div>
        ) : isLoggedIn ? (
          <>
            <a
            ...
            <button
              ...
              className="flex-1 py-5 px-8 glass hover:bg-white/10 text-slate-300 font-black text-xl rounded-3xl transition-all transform hover:-translate-y-1 active:scale-95 border border-white/20 shadow-2xl text-center"
            >
              로그아웃
            </button>
          </>
